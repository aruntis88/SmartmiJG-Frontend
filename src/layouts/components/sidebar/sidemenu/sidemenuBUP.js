    ...
    return (
      ...
      >
        ...
        <SideMenu.MenuSingleItem>
          <NavLink to="" activeclassname="active" className="menulable">
            <span className="menu-item-text">SALES</span>
          </NavLink>
        </SideMenu.MenuSingleItem>
        <SideMenu.MenuSingleItem>
        ...
        <SideMenu.MenuSingleItem>
          <NavLink to="" activeclassname="active" className="menulable">
            <span className="menu-item-text">Masters</span>
          </NavLink>
        </SideMenu.MenuSingleItem>
        <SideMenu.MenuMultiItems
          name="Products"
          Icon={<i class="menu-icon producs-smartmi" />}
          ArrowRight={<ChevronRight size={16} />}
          collapsedSidebar={this.props.collapsedSidebar}
        >
          <NavLink
          ...
          <NavLink
            ...
            activeclassname="active"
          >
            <span className="menu-item-text">Product Categories</span>
          </NavLink>
        </SideMenu.MenuMultiItems>
        <SideMenu.MenuMultiItems
          name="Users"
          Icon={<i class="menu-icon users-smartmi" />}
          ArrowRight={<ChevronRight size={16} />}
          collapsedSidebar={this.props.collapsedSidebar}
        >
          <NavLink to="/users" exact className="item" activeclassname="active">
            <span className="menu-item-text">Roles & Accessibilities</span>
          </NavLink>
        </SideMenu.MenuMultiItems>
        <SideMenu.MenuSingleItem>
        ...
        <SideMenu.MenuMultiItems
          name="Projects"
          Icon={<i class="menu-icon projects-smartmi" />}
          ArrowRight={<ChevronRight size={16} />}
          collapsedSidebar={this.props.collapsedSidebar}
        >
          ...
          <NavLink to="/projects-requirement" activeclassname="active">
            <span className="menu-item-text">Projects Requirement</span>
          </NavLink>
        </SideMenu.MenuMultiItems>
        <SideMenu.MenuSingleItem></SideMenu.MenuSingleItem>
        <SideMenu.MenuSingleItem>
        ...
        >
          <SideMenu toggleSidebarMenu={this.props.toggleSidebarMenu}>
            ...
            >
              ...
              <NavLink
                to="/components/bootstrap/breadcrumbs"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/components/bootstrap/alerts"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/components/bootstrap/badges"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/components/bootstrap/dropdowns"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/components/bootstrap/pagination"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/components/bootstrap/progress-bars"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/components/bootstrap/collapse"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/components/bootstrap/popover"
                className="item"
                activeclassname="active"
              >
            ...
            >
              ...
              <NavLink
                to="/components/extra/input-tags"
                className="item"
                activeclassname="active"
              >
        ...
        >
          <SideMenu toggleSidebarMenu={this.props.toggleSidebarMenu}>
            ...
            >
              ...
              <NavLink
                to="/forms/layouts/horizontal-forms"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/forms/layouts/hidden-labels"
                className="item"
                activeclassname="active"
              >
              ...
              <NavLink
                to="/forms/layouts/bordered-forms"
                className="item"
                activeclassname="active"
              >
