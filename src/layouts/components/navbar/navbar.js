...
class ThemeNavbar extends Component {
  ...
  render() {
    return (
      <Navbar className="navbar navbar-expand-lg navbar-light bg-faded smartmiNav col-md-12">
        ...
        <div className="container-fluid px-0">
          ...
          <div className="navbar-container">
            {/* <Form
              className="navbar-form mt-1 float-left globalSearch"
              role="search"
            >
              <Search
                size={20}
              ...
              />
              <Collapse right isOpen={this.state.isOpenSearch}>
                <NavbarSearch />
              </Collapse>
            </Form> */}
            <div id="wrap" className="t-1 float-left globalSearch">
              ...
              <Nav className="ml-auto float-right" navbar>
                ...
                <UncontrolledDropdown nav inNavbar className="pr-1">
                  <DropdownToggle nav>
                    ...
                    <Bell
                      size={21}
                      className=" notification-danger animate-shake"
                      color="#B3B8CF"
                    />
                  </DropdownToggle>
                ...
                <NavItem className="pr-1">
                    ...
                    <Settings size={20} color="#B3B8CF" />
                
                </NavItem>
                <UncontrolledDropdown nav inNavbar className="pr-1">
                  <DropdownToggle nav>
                    <span className="userWrapper">
                      Hi, <span className="userName">Arun</span>
                    </span>
                    <img
                      src={userImage}
                      alt="logged-in-user"
